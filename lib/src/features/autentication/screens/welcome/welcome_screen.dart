                ...
                children: [
                  Expanded(
                      child: ElevatedButton(
                          onPressed: () => Get.to(()=> LoginScreen(), transition: Transition.leftToRight, duration: Duration(milliseconds: 700)),
                  ...
                  Expanded(
                    child: ElevatedButton(
                        onPressed: () => Get.to(SignUpScreen(), transition: Transition.leftToRight, duration: Duration(milliseconds: 700)),
